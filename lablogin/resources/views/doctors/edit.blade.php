          ...
          <div class="px-1 py-1 bg-white sm:p-6">
            <div class="grid grid-cols-6 gap-6">
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                Current choice: {{ $doctor->gender }} <br><br>
              ...
              <input type="tel" name="phonenumber" value="{{ $doctor->phonenumber }}" class="form-control rounded-pill" placeholder="Phone number" maxlength ="11">              </div>
    </div>
    <br><br>
